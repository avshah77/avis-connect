...
from connect.core import engine, registry
from connect.core.crypto import decrypt
from connect.db import get_db
from connect.models import Credential, PushLog
...
def health_check(connector_type: str, project_slug: str, db: Session = Depends(get_db)):
    from connect.models import Project
